...
class CoolKettle(Kitchen):
    ...
    Steps:
        ...
        2) Wait 300 timesteps before picking it up.
    ...
    def get_ep_meta(self):
        ...
        ep_meta[
            "lang"
        ] = "The kettle is done boiling. Turn off the stove, then wait for 300 timesteps before moving the kettle to the dining table."
