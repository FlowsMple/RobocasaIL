...
class SoakSponge(Kitchen):
    ...
    Steps:
        ...
        Ensure the sponge is soaked for at least 50 timesteps.
    ...
    def _check_success(self):
        """
        Checks if the sponge has been held under running water for at least 50 timesteps.

        Returns:
            bool: True if the sponge is soaked for 50 timesteps, False otherwise.
        """
        ...
        return self.sponge_contact_time >= 50 and gripper_far_sponge and sponge_in_sink
