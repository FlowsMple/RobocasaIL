...
class ArrangeBuffetDessert(Kitchen):
    ...
    def _setup_kitchen_references(self):
        ...
        self.dining_counter = self.register_fixture_ref("dining_counter", dict(
            id=FixtureType.DINING_COUNTER, ref=self.stool)
        )
    ...
    def _check_success(self):
        ...
        tray_on_counter = OU.check_obj_fixture_contact(self, "tray", self.dining_counter)
        
        gripper_far = (
            OU.gripper_obj_far(self, obj_name="sweet1", th=0.15) and
            OU.gripper_obj_far(self, obj_name="sweet2", th=0.15) and
            OU.gripper_obj_far(self, obj_name="tray", th=0.15)
        )
